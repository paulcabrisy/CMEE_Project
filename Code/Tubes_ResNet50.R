...
ResNet50_5000<- read.csv('/Volumes/Paul/Resnets/Tubes/resnet_50/dist_5000.csv', header = FALSE)
ResNet50_8000<- read.csv('/Volumes/Paul/Resnets/Tubes/resnet_50/dist_8000.csv', header = FALSE)
ResNet50_9000<- read.csv('/Volumes/Paul/Resnets/Tubes/resnet_50/dist_9000.csv', header = FALSE)
ResNet50_7000<- read.csv('/Volumes/Paul/Resnets/Tubes/resnet_50/dist_7000.csv', header = FALSE)
ResNet50_10000<- read.csv('/Volumes/Paul/Resnets/Tubes/resnet_50/dist_10000.csv', header = FALSE)
ResNet50_6000<- read.csv('/Volumes/Paul/Resnets/Tubes/resnet_50/dist_6000.csv', header = FALSE)
ResNet50_11000<- read.csv('/Volumes/Paul/Resnets/Tubes/resnet_50/dist_11000.csv', header = FALSE)
ResNet50_12000<- read.csv('/Volumes/Paul/Resnets/Tubes/resnet_50/dist_12000.csv', header = FALSE)
ResNet50_13000<- read.csv('/Volumes/Paul/Resnets/Tubes/resnet_50/dist_13000.csv', header = FALSE)
ResNet50_14000<- read.csv('/Volumes/Paul/Resnets/Tubes/resnet_50/dist_14000.csv', header = FALSE)
ResNet50_15000<- read.csv('/Volumes/Paul/Resnets/Tubes/resnet_50/dist_15000.csv', header = FALSE)
ResNet50_16000<- read.csv('/Volumes/Paul/Resnets/Tubes/resnet_50/dist_16000.csv', header = FALSE)
ResNet50_17000<- read.csv('/Volumes/Paul/Resnets/Tubes/resnet_50/dist_17000.csv', header = FALSE)
ResNet50_18000<- read.csv('/Volumes/Paul/Resnets/Tubes/resnet_50/dist_18000.csv', header = FALSE)
ResNet50_19000<- read.csv('/Volumes/Paul/Resnets/Tubes/resnet_50/dist_19000.csv', header = FALSE)
ResNet50_20000<- read.csv('/Volumes/Paul/Resnets/Tubes/resnet_50/dist_20000.csv', header = FALSE)
#read in data
...
data4 <- ResNet50_8000
data5 <- ResNet50_9000
data6 <- ResNet50_10000
data7 <- ResNet50_11000
data8 <- ResNet50_12000
data9 <- ResNet50_13000
data10 <- ResNet50_14000
data11 <- ResNet50_15000
data12 <- ResNet50_16000
data13 <- ResNet50_17000
data14 <- ResNet50_18000
data15 <- ResNet50_19000
data16 <- ResNet50_20000
...
saveRDS(ResNet50, file = 'ResNet50.rds')
