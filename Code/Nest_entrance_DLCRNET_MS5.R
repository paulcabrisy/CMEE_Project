...
dlcrnet_ms5_9000<- read.csv('/Volumes/Paul/Resnets/Trap/dlcrnet_ms5/dist_9000.csv', header = FALSE)
dlcrnet_ms5_7000<- read.csv('/Volumes/Paul/Resnets/Trap/dlcrnet_ms5/dist_7000.csv', header = FALSE)
dlcrnet_ms5_10000<- read.csv('/Volumes/Paul/Resnets/Trap/dlcrnet_ms5/dist_10000.csv', header = FALSE)
dlcrnet_ms5_6000<- read.csv('/Volumes/Paul/Resnets/Trap/dlcrnet_ms5/dist_6000.csv', header = FALSE)
dlcrnet_ms5_11000<- read.csv('/Volumes/Paul/Resnets/Trap/dlcrnet_ms5/dist_11000.csv', header = FALSE)
dlcrnet_ms5_12000<- read.csv('/Volumes/Paul/Resnets/Trap/dlcrnet_ms5/dist_12000.csv', header = FALSE)
dlcrnet_ms5_13000<- read.csv('/Volumes/Paul/Resnets/Trap/dlcrnet_ms5/dist_13000.csv', header = FALSE)
dlcrnet_ms5_14000<- read.csv('/Volumes/Paul/Resnets/Trap/dlcrnet_ms5/dist_14000.csv', header = FALSE)
dlcrnet_ms5_15000<- read.csv('/Volumes/Paul/Resnets/Trap/dlcrnet_ms5/dist_15000.csv', header = FALSE)
dlcrnet_ms5_16000<- read.csv('/Volumes/Paul/Resnets/Trap/dlcrnet_ms5/dist_16000.csv', header = FALSE)
dlcrnet_ms5_17000<- read.csv('/Volumes/Paul/Resnets/Trap/dlcrnet_ms5/dist_17000.csv', header = FALSE)
dlcrnet_ms5_18000<- read.csv('/Volumes/Paul/Resnets/Trap/dlcrnet_ms5/dist_18000.csv', header = FALSE)
dlcrnet_ms5_19000<- read.csv('/Volumes/Paul/Resnets/Trap/dlcrnet_ms5/dist_19000.csv', header = FALSE)
dlcrnet_ms5_20000<- read.csv('/Volumes/Paul/Resnets/Trap/dlcrnet_ms5/dist_20000.csv', header = FALSE)
...
dlcrnet_ms5 <- readRDS(file = 'Trap_dlcrnet_ms5.rds')
...
ggp2 <- ggp2 + # Add polynomial regression curve
  stat_smooth(method = "lm",formula = y ~ poly(x, 4), color = c('red'), se = F)+ 
    stat_regline_equation(label.y = 300, aes(label = ..eq.label..)) +
    stat_regline_equation(label.y = 270, aes(label = ..rr.label..))
...
a <- subset.data.frame(ResNet50, ResNet50$Iters == '15000')
b <- subset.data.frame(ResNet101, ResNet101$Iters == '15000')
c <- subset.data.frame(dlcrnet_ms5, dlcrnet_ms5$Iters == '9000')
...
p <- ggplot(Networks, aes(Model, RMSE))  +
  ...
  geom_signif(comparisons = list(c("dlcrnet_ms5", "resnet_101"),
            ...
            map_signif_level=TRUE, textsize = 4, col="black", vjust = 0.1,y_position = c(37, 39,37))
